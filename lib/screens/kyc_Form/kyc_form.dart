...
class kyc_form extends StatefulWidget {
  final int clientId;
  const kyc_form({Key? key, required this.clientId}) : super(key: key);
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: (text) =>
                                  EmailValidator.validate(text!.trim())
                                      ? null
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter business activity ';
                                }
                                return null;
                              },
                        ...
                        Text(
                          'If Your business is international, list the countries in which you do business and the address of each country',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 12,
                          ),
