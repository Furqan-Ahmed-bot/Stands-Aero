...
class credit_form extends StatefulWidget {
  final int clientId;
  const credit_form({Key? key, required this.clientId}) : super(key: key);
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter Date Business Started';
                                }
                                return null;
                              },
                              onTap: () async {
                              ...
                              decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.symmetric(horizontal: 10),
                                  labelText: "Date Business Started",
                                  labelStyle: TextStyle(
                                      color: myFocusNode.hasFocus
                                          ? Colors.white
                                          : Colors.black)),
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter your type of business';
                                }
                                return null;
                              },
                              decoration: InputDecoration(
