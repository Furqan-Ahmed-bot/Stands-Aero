...
class _credit_from2State extends State<credit_from2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: requestFormdatafromQuote != null
          ? FutureBuilder<void>(
              // future: ,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          textfiel_kyc(
                              controller: sig_date, res_width: res_width),
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              log("aaja bhai4 " +
                                  requestFormdatafromQuote['date_to']
                                      .toString());
                              ...
                              if (requestFormdatafromQuote['product_id'] !=
                                ...
                                var sendData = {
                                  ...
                                  'kyc_client_id': usercontroller.user.id,
                                  'kyc_company_name':
